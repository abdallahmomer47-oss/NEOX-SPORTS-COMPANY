...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <span class="sub-title">Sports Company</span>
        </div>
        <nav>
            <ul>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Premium Sportbekleidung, Profi-Equipment und High-Performance Supplements für alle Athleten.</p>
    ...
    <section class="bestseller">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <span class="badge">Neu</span>
                <div class="product-img-placeholder">⚽</div>
                <h3>NEOX Match Football</h3>
                <span class="price">24,99 €</span>
            </div>
        </div>
        <button class="btn-shop">Zum Shop</button>
    </section>
